...
public class Main {
  public static void main(String[] args) throws IOException {
    Scanner sc=new Scanner(new BufferedReader(new FileReader("C:\\Users\\Anand\\Desktop\\program\\input.txt")));      
    ...
    PrintWriter fw = new PrintWriter(new BufferedWriter(new FileWriter("C:\\Users\\Anand\\Desktop\\program\\output.txt")));
